...
created_at: "2026-08-23T14:34:20Z"
updated_at: "2026-08-23T14:38:17Z"
state_rev: "sha256:8d5e4206b3fdbba41768b54fa602549dfe294b9f4cff43b862f08c4a22d39ef3"
---
...
|---|---|---|---|
| Product | User-facing purpose, limits, and supported surfaces. | `knowledge/domains/product/INDEX.md` | `knowledge/domains/product/CANON.md` |
| Project | Durable project knowledge. | `knowledge/domains/project/INDEX.md` | `knowledge/domains/project/CANON.md` |
| Release | Build, test, package, sign, install, and publish paths. | `knowledge/domains/release/INDEX.md` | `knowledge/domains/release/CANON.md` |
| Runtime | Rust worker, CLI, MCP, device session, and local state. | `knowledge/domains/runtime/INDEX.md` | `knowledge/domains/runtime/CANON.md` |
| Workflows | Workflow JSON contracts, catalog, safety, and authoring. | `knowledge/domains/workflows/INDEX.md` | `knowledge/domains/workflows/CANON.md` |
