# Agent Handoff For RZN Phone Automation

Use this file when an agent is asked to set up or diagnose the local RZN Phone Automation capability.

## Objective

Set up the shipped RZN Phone Automation plugin on this machine and validate it with one read-only workflow.
